  ...
  "client-a.local": {
    ...
    content: {
      ...
      // Data for parallax cards
        ...
        { 
            title: "WHO AM I?", 
            subtitle: "Senior Front End Engineer with 9+ years of experience architecting high-scale e-commerce and membership platforms.",
...
portfolio: {
  ...
  "localhost": {
    ...
    content: {
      ...
      description: "You are running the app locally."
    }
  }
};
